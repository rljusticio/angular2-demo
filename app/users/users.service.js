        ...
        execute: function() {
            UsersService = (function () {
                ...
                UsersService.prototype.addUser = function (user) {
                    return this._http.post(this.url, JSON.stringify(user)).map(function (res) { return res.json(); });
                };
                UsersService.prototype.updateUser = function (id) {
                    return this._http.get(this.url + '/' + id).map(function (res) { return res.json(); });
                };
                UsersService.prototype.editUser = function (user, id) {
                    return this._http.put(this.url + '/' + id, JSON.stringify(user)).map(function (res) { return res.json(); });
                };
